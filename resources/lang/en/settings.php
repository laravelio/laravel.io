...
return [
    ...
    'api_token' => [
        ...
        <div x-data="{ showApi: false, copyToast: false }" class="flex justify-end items-center"><input x-bind:type="!showApi ? \'password\' : \'text\'" name="apikey" readonly="readonly" value=":token" class="bg-white mr-2 text-gray-800 px-2 py-1 rounded-md"> 
        
        <svg aria-label="Copy API key" @click="navigator.clipboard.writeText(\':token\'); copyToast = true; setTimeout(() => copyToast = false, 4000)" class="mr-2 hover:cursor-pointer" style="width:24px;height:24px" viewBox="0 0 24 24">
