                                    ...
                                    <div class="flex mb-4 md:mb-0">
                                        ...
                                        <div class="mr-6 text-gray-700">
                                            @if (count($thread->replies()))
                                                ...
                                                <a href="{{ route('profile', $lastReply->author()->username()) }}" class="text-green-700 mr-2">{{ $lastReply->author()->name() }}</a> replied
                                                {{ $lastReply->createdAt()->diffForHumans() }}
                                            @else
                                                <a href="{{ route('profile', $thread->author()->username()) }}" class="text-green-700 mr-2">{{ $thread->author()->name() }}</a> posted
