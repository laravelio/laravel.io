...
@section('content')
    <div class="container prose mx-auto px-4 py-10">
        ...
        <p><strong class="text-xs uppercase">Last updated: May 22, 2018</strong></p>

        <p>
            These Terms and Conditions ("Terms", "Terms and Conditions") govern your relationship with
            https://laravel.io website (the "Service") operated by Laravel.io ("us", "we", or "our").
        </p>
        ...
        <p>
            ...
            and will remain the exclusive property of Laravel.io and its licensors. The Service is protected by
            copyright, trademark, and other laws of both the Belgium and foreign countries. Our trademarks and trade
        ...
        <p>
            Laravel.io has no control over, and assumes no responsibility for, the content, privacy policies, or
            practices of any third party web sites or services. You further acknowledge and agree that Laravel.io shall
        ...
        <p>
            In no event shall Laravel.io, nor its directors, employees, partners, agents, suppliers, or affiliates, be
        ...
        <p>
            Laravel.io its subsidiaries, affiliates, and its licensors do not warrant that a) the Service will function
