...
@section('content')
    <div class="container prose mx-auto px-4 py-10">
        ...
        <p>
            ...
            your relationship with https://laravel.io website (the "Service")
        ...
        <p>
            ...
            property of Laravel.io and its licensors. The Service is protected
            by copyright, trademark, and other laws of both the Belgium and
            foreign countries. Our trademarks and trade dress may not be used in
            connection with any product or service without the prior written
            consent of Laravel.io.
        </p>
        ...
        <p>
            ...
            that are not owned or controlled by Laravel.io.
        </p>

        <p>
            Laravel.io has no control over, and assumes no responsibility for,
            the content, privacy policies, or practices of any third party web
            sites or services. You further acknowledge and agree that Laravel.io
        ...
        <p>
            In no event shall Laravel.io, nor its directors, employees,
        ...
        <p>
            Laravel.io its subsidiaries, affiliates, and its licensors do not
        ...
        <p>
            ...
            laws of Belgium, without regard to its conflict of law provisions.
        </p>
