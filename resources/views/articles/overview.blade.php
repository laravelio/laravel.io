...
@section('content')
    ...
    <div class="bg-lio-100">
        <div
            class="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:flex lg:items-center lg:justify-between lg:px-8 lg:py-20"
        >
            <h2
            ...
            >
                ...
                <span class="block">
                    ...
                    <a
                        ...
                        class="text-lio-500 hover:text-lio-600 hover:underline"
                    >
        ...
        <div class="container mx-auto flex flex-col gap-x-12 px-4 lg:flex-row">
            <div class="lg:w-3/4">
                <div class="flex items-center justify-between lg:block">
                    ...
                    @if ($activeTag)
                        <div
                            class="mt-4 hidden items-center gap-x-4 border-t pt-5 lg:flex"
                        >
                            Filter applied
                            <x-tag>
                                <span class="flex items-center gap-x-1">
                                    {{ $activeTag->name() }}
                                    <a
                                        href="{{ route('articles', ['filter' => $filter]) }}"
                                        type="button"
                                    >
                ...
                <div class="mt-6 rounded-md bg-white shadow">
                    ...
                    <ul>
                        @foreach ($topAuthors as $author)
                            <li
                                class="{{ ! $loop->last ? 'border-b ' : '' }}pb-3 pt-5"
                            >
                                <div
                                ...
                                >
                                    ...
                                    <div>
                                        <span
                                            class="flex items-center gap-x-3 text-lio-500"
                                        >
