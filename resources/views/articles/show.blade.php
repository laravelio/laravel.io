    ...
    <article class="bg-white">
        @auth
            ...
            @elseif ($article->isPublished() && $article->isAuthoredBy(Auth::user()))
                <x-info-banner>
                    Your article is now published and cannot be edited anymore. If you want to perform any changes to the article, please email
            ...
            <div class="flex px-4 lg:mx-48 lg:px-0">
                ...
                <div class="w-full pt-4 lg:w-4/5 lg:pt-10">
                    ...
                    @if ($article->isUpdated())
                        <div class="py-6 text-sm text-gray-900">Last updated {{ $article->updated_at->diffForHumans() }}.</div>
                    @endif
