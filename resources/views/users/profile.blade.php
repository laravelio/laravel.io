...
@section('content')
<div class="border-b">
    <div class="container mx-auto px-4 flex flex-col md:flex-row mt-8">
                ...
                <div class="flex flex-wrap mt-24" x-show="tab == 'overview'">
                    <div class="w-1/3 h-40 justify-center flex mb-4">
                        <div class="flex flex-col items-center text-center">
                            ...
                            <div class="text-gray-800 uppercase mt-4">
                                <span class="text-2xl block">{{ $user->countThreads() }}</span>
                    ...
                    <div class="w-1/3 h-40 justify-center flex mb-4">
                        <div class="flex flex-col items-center text-center">
                            ...
                            <div class="text-gray-800 uppercase mt-4">
                                <span class="text-2xl block">{{ $user->countReplies() }}</span>
                    ...
                    <div class="w-1/3 h-40 justify-center flex mb-4">
                        <div class="flex flex-col items-center text-center">
                            ...
                            <div class="text-gray-800 uppercase mt-4">
                                <span class="text-2xl block">{{ $user->countSolutions() }}</span>
