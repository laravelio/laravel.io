            ...
            <div class="space-y-6 bg-white px-4 py-6 sm:p-6">
                ...
                <div class="flex flex-col space-y-6 lg:flex-row lg:space-x-6 lg:space-y-0">
                    ...
                    <div class="grow space-y-1 lg:shrink-0 lg:grow-0">
                        <p class="block text-sm font-medium leading-5 text-gray-700" aria-hidden="true">Profile Image</p>
                        ...
                        <div class="mt-2 flex items-center">
                            <div class="inline-block shrink-0 overflow-hidden" aria-hidden="true">
                                ...
                                <span class="mt-4 inline-block text-sm text-gray-500">
                                    ...
                                    <a href="https://github.com/{{ Auth::user()->githubUsername() }}" class="text-lio-700"> your GitHub profile </a
                                    >.
                                </span>
                            </div>
                        </div>
                ...
                <div class="grid grid-cols-12 gap-6">
                    ...
                    <div class="col-span-12 sm:col-span-6">
                        ...
                        <span class="mt-2 text-sm text-gray-500"> Enter your Twitter handle without the leading @ symbol </span>
                    </div>
                </div>
            </div>
