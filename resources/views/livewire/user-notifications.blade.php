    ...
    <div class="md:flex md:items-center md:justify-between border-b border-gray-200 pb-4">
        ...
        @if ($notificationCount)
            <div class="mt-4 flex md:mt-0 md:ml-4">
                <button  @click="activeModal = 'markAllAsRead'" class="bg-white border border-gray-200 rounded-sm py-2 px-4 inline-flex justify-center text-sm text-gray-900 hover:bg-gray-100 font-medium">
            ...
            @if ($notifications->total())
                <div class="flex flex-col bg-white mb-4 lg:rounded-lg">
                    <div class="overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
                        <div class="align-middle inline-block min-w-full shadow-sm overflow-hidden lg:rounded-lg">
                ...
                {{ $notifications->links() }}
            @else
                <div class="relative block w-full rounded-lg border-2 border-dashed border-gray-300 p-12 text-center hover:border-gray-400 focus:outline-hidden focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
