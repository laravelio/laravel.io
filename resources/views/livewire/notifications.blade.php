<div>
    <div class="border-b border-gray-200 pb-4 md:flex md:items-center md:justify-between">
        <div class="min-w-0 flex-1">
            <h2 class="text-2xl font-bold leading-7 text-gray-900 sm:truncate sm:text-4xl">
                Notifications

                <span class="rounded-full bg-lio-100 px-3 text-2xl text-lio-500">
                    {{ $notificationCount }}
                </span>
            </h2>
        </div>
    ...
    <div class="my-4">
        <div class="pb-4">
            @if ($notifications->total())
                ...
                {{ $notifications->links() }}
            @else
                <p class="text-base text-gray-600">You have no unread notifications</p>
            @endif
        </div>
    </div>
