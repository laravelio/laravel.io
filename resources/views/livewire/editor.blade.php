<div class="editor">
    ...
    <div
        x-data="editorConfig(@entangle('body'), {{ $hasMentions }})"
        class="{{ $hasShadow ? 'shadow-md' : '' }} rounded-md bg-white"
    >
        ...
        <div x-show="mode === 'write'">
            <div class="relative flex flex-col">
                <div
                    x-text="body + '\n'"
                    class="invisible min-h-[5rem] whitespace-pre-line border-none p-5"
                ></div>
                <textarea
                    ...
                    >
                        @foreach ($users as $user)
                            ...
                            >
                                ...
                                <small
                                    class="text-sm text-gray-500 text-gray-900"
                                >
                                    {{ $user['name'] }}
                                </small>
                            </li>
            ...
            <div
                class="flex flex-col items-center justify-end gap-x-5 gap-y-4 p-5 md:flex-row"
            >
        ...
        <div x-show="mode === 'preview'" x-cloak>
            <div
                class="prose-lio prose max-w-none break-words p-5"
                id="editor-preview"
            >
                {!! $this->preview !!}
            </div>
