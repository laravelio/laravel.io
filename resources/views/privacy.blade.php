...
@section('content')
    <div class="container prose mx-auto px-4 py-10">
        ...
        <p>
            ...
            itself or through third parties, there are: email address; username;
            password; Cookies.
        </p>
        ...
        <p>
            ...
            by the owners of third-party services used by this Website serves
            the purpose of providing the Service required by the User, in
        ...
        <p>
            ...
            activity, as well as the following: Hosting and backend
            infrastructure, Registration and authentication, Registration and
            authentication provided directly by this Website, Traffic
            optimization and distribution and Managing contacts and sending
            messages.
        </p>
        ...
        <p>
            ...
            enable this Website to run and be distributed as well as to provide
            a ready-made infrastructure to run specific features or parts of
            this Website. Some of these services work through geographically
        ...
        <p>
            By registering or authenticating, Users allow this Website to
            identify them and give them access to dedicated services.
            <br />
            Depending on what is described below, third parties may provide
            registration and authentication services. In this case, this Website
        ...
        <p>
            ...
            providing the Personal Data directly to this Website.
        </p>
        ...
        <p>
            ...
            the way these services are implemented. Their function is to filter
            communications between this Website and the User's browser.
            <br />
            Considering the widespread distribution of this system, it is
            difficult to determine the locations to which the contents that may
            contain Personal Information of the User are transferred.
        </p>
        ...
        <p>
            ...
            traffic through this Website, i.e., communication between this
            Website and the User's browser, while also allowing analytical data
            from this Website to be collected.
        </p>

        <p>
            Personal Data processed: Cookies; various types of Data as specified
        ...
        <p>
            ...
            measures concerning the operation and use of this Website. The Data
