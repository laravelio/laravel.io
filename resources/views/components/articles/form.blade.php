    ...
    <div class="space-y-6 bg-gray-100 px-4 py-6 sm:p-6">
        <div>
            ...
            <x-info class="mt-4">
                ...
                which has over 50,000 followers. Feel free to submit as many articles as you like. You can even cross-reference an article on your
                blog with the original url.
            </x-info>
            ...
            <x-info class="mt-4">
                ...
                <strong>
                    After being published, you cannot edit your article anymore so please review it thoroughly before submitting for approval.
                </strong>
