...
<div class="flex items-center lg:gap-x-3">
    ...
    @can(App\Policies\ThreadPolicy::UPDATE, $thread)
        ...
        @else
            <button class="flex items-center font-medium text-gray-300 hover:text-lio-500" @click="activeModal = 'markSolution-{{ $reply->id }}'">
                <x-heroicon-o-check-badge class="h-6 w-6" />
        ...
        <div class="relative -mr-3" x-data="{ open: false }" @click.outside="open = false">
            ...
            <div x-cloak x-show="open" class="absolute right-1 top-12 z-10 flex w-48 flex-col rounded bg-white shadow">
                @can(App\Policies\ReplyPolicy::UPDATE, $reply)
                    <button x-show="! edit" class="flex gap-x-2 rounded p-3 hover:bg-gray-100" @click="edit = true; open = false;">
                ...
                @can(App\Policies\ReplyPolicy::DELETE, $reply)
                    <button class="flex gap-x-2 rounded p-3 hover:bg-gray-100" @click="activeModal = 'deleteReply-{{ $reply->id }}'">
                ...
                @can(App\Policies\ReplyPolicy::REPORT_SPAM, $reply)
                    <button class="flex gap-x-2 rounded p-3 hover:bg-gray-100" @click="activeModal = 'markAsSpam-{{ $reply->id }}'">
