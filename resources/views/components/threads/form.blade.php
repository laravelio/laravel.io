...
<x-buk-form action="{{ route(...$route) }}" :method="$method" x-data="{}" @submitted.stop="$event.currentTarget.submit()">
    <div class="space-y-6 bg-gray-100 px-4 py-6 sm:p-6">
        <div>
            ...
            <x-info class="mt-4">
                ...
                <br />
                Want to share large code snippets? Share them through
                <a href="https://paste.laravel.io" class="text-lio-700 underline">our pastebin</a>
                .
            </x-info>
        </div>
        ...
        <div class="flex flex-col space-y-6">
            <div class="grow space-y-6">
                <div class="space-y-1">
                    ...
                    <span class="mt-2 text-sm text-gray-500">Maximum 60 characters.</span>
                </div>
            </div>
