    ...
    <div @click.outside="searchVisible = false"
        ...
        <div class="relative">
            ...
            <kbd @keyup.window.escape="searchVisible = false" @click="searchVisible = false"
                class="absolute right-4 top-3.5 cursor-pointer rounded bg-gray-100 px-2 py-1 text-xs text-gray-500">ESC</kbd>
        </div>
        ...
        <div x-show="searchQuery.length && (threads.total || articles.total || users.total)" x-data="tabConfig()"
            x-init="$watch('activeTab', value => setActiveTab(value))" x-cloak>
            <ul class="grid grid-flow-col rounded-lg bg-gray-100 p-1 text-center text-gray-500">
                <li>
                    <a href="javascript:void(0)" @click="activeTab = 'threads'" class="flex justify-center py-4"
                ...
                <li>
                    <a href="javascript:void(0)" @click="activeTab = 'articles'" class="flex justify-center py-4"
                ...
                <li>
                    <a href="javascript:void(0)" @click="activeTab = 'users'" class="flex justify-center py-4"
            ...
            <ul>
                ...
                <li class="cursor-default select-none px-4 py-2 hover:bg-lio-100" :id="`option-${thread.id}`"
                    ...
                    <a :href="'/forum/' + thread.slug" class="flex flex-col">
                        <span class="text-black-900 break-all font-medium"
        ...
        <div class="flex flex-wrap items-center justify-end bg-gray-50 px-4 py-2.5 text-xs text-gray-700">
            <a href="https://algolia.com">
                <img loading="lazy" src="{{ asset('images/algolia.svg') }}" alt="Magnifying glass icon"
                    class="h-4" />
            </a>
        </div>
    </div>
