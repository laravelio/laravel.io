...
>
    ...
    >
        ...
        >
            <ul
                class="grid grid-flow-col rounded-lg bg-gray-100 p-1 text-center text-gray-500"
            >
                <li>
                    <a
        ...
        <div
            class="flex flex-wrap items-center justify-end bg-gray-50 px-4 py-2.5 text-xs text-gray-700"
        >
            <a href="https://algolia.com">
                <img
                    loading="lazy"
                    src="{{ asset('images/algolia.svg') }}"
