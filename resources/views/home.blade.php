...
@section('body')
    ...
    <section class="container mx-auto mt-12 px-4 lg:mt-24 lg:px-16">
        <div class="mb-8 flex flex-col items-center lg:mb-16 lg:flex-row">
            <h2 class="mb-2 w-full text-3xl font-bold text-gray-900 lg:mb-0 lg:w-1/2 lg:text-4xl">
                Latest articles
            </h2>
    ...
    <section class="container mx-auto mt-12 px-4 lg:mt-40 lg:px-16">
        <h2 class="mb-6 text-center text-4xl font-bold leading-tight text-gray-900 lg:mb-12">
            Laravel.io in numbers
        </h2>
