...
<a href="{{ $banner['url'] }}" target="_blank" rel="noopener noreferrer" onclick="fathom.trackGoal('{{ $banner['goal'] }}', 0);">
    ...
    <img class="hidden md:block my-4 mx-auto w-full" style="max-width:1200px" src="{{ asset("/images/showcase/{$banner['image']}-long.png") }}" alt="{{ $banner['alt'] }}">

    {{-- Show the square on mobile. --}}
    <img class="md:hidden my-4 mx-auto w-full" style="max-width:300px" src="{{ asset("/images/showcase/{$banner['image']}-small.png") }}" alt="{{ $banner['alt'] }}">
</a>
