        ...
        <div class="mx-4 md:mx-0">
                ...
                <div class="lg:w-full lg:flex lg:justify-between">
                    <div class="flex-grow mb-6 lg:mb-0">
                        ...
                        <div class="flex flex-wrap lg:flex-col lg:flex-no-wrap">
                            <a href="{{ route('forum') }}" class="w-1/2 text-gray-400 mb-4 lg:mb-6">
                                Forum
                            </a>

                            <a href="{{ route('articles') }}" class="w-1/2 text-gray-400 mb-4 lg:mb-6">
                                Articles
                            </a>

                            <a href="https://paste.laravel.io" class="w-1/2 text-gray-400 mb-4 lg:mb-6">
                                Pastebin
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="flex-grow mb-6 lg:mb-0">
                        ...
                        <div class="flex flex-wrap lg:flex-col lg:flex-no-wrap">
                            <a href="https://twitter.com/laravelio" class="w-1/2 text-gray-400 mb-4 lg:mb-6">
                                <x-icon-twitter class="text-white w-4 h-4 inline mr-3.5"/>
                                Twitter
                            </a>

                            <a href="https://github.com/laravelio" class="w-1/2 text-gray-400 mb-4 lg:mb-6">
            ...
            <div class="text-gray-100 flex flex-col lg:flex-row">
                ...
                <div class="flex flex-wrap lg:block">
                    <a href="https://laravel.io/terms" class="w-1/2 mb-4 lg:w-full lg:mb-0 lg:mr-8">Terms of service</a>
                    <a href="https://laravel.io/privacy" class="w-1/2 mb-4 lg:w-full lg:mb-0 lg:mr-8">Privacy policy</a>
                    <a href="https://github.com/sponsors/laravelio" class="w-1/2 lg:w-full lg:mb-0">Advertise</a>
                </div>
            </div>
        </div>
    </div>
