        ...
        <div class="mx-4 md:mx-0">
            <div class="mb-8 flex flex-col border-b border-gray-800 pb-8 lg:flex-row lg:pb-16">
                <div class="mb-6 w-full lg:mb-0 lg:w-2/5 lg:pr-20">
                    <img loading="lazy" src="{{ asset('images/laravelio-logo-white.svg') }}" alt="{{ config('app.name') }}"
                        class="mb-5 block" />
                ...
                <div class="lg:flex lg:w-full lg:justify-between">
                    <div class="mb-6 grow lg:mb-0">
                        <p class="mb-4 text-lg lg:mb-6">
                            Laravel.io
                        </p>

                        <div class="lg:flex-no-wrap flex flex-wrap lg:flex-col">
                            <a href="{{ route('forum') }}" class="mb-4 w-1/2 text-gray-400 hover:text-gray-200 lg:mb-6">
                                Forum
                            </a>
                        ...
                        <div class="flex flex-col flex-nowrap">
                            <div class="mb-4 flex lg:mb-6">
                                <a href="https://laravel.com" class="w-1/2 text-gray-400 hover:text-gray-200">
                                    <img loading="lazy" src="{{ asset('images/laravel.png') }}" alt="Laravel"
                                        class="mr-2 inline h-4 w-4" />
                                    Laravel
                                </a>

                                <a href="https://laravel-news.com" class="w-1/2 text-gray-400 hover:text-gray-200">
                                    <img loading="lazy" src="{{ asset('images/laravel-news.png') }}" alt="Laravel News"
                                        class="mr-2 inline h-4 w-4" />
                                    Laravel News
                                </a>
                            </div>
                            ...
                            <div class="flex">
                                <a href="https://laracasts.com" class="w-1/2 text-gray-400 hover:text-gray-200">
                                    <img loading="lazy" src="{{ asset('images/laracasts.png') }}" alt="Laracasts"
                                        class="mr-2 inline h-4 w-4" />
                                    Laracasts
                                </a>
                                ...
                                <a href="https://www.laravelpodcast.com"
                                    ...
                                    <img loading="lazy" src="{{ asset('images/podcast.png') }}" alt="Laravel Podcast"
                                        class="mr-2 inline h-4 w-4" />
                                    Laravel Podcast
                                </a>
                            </div>
