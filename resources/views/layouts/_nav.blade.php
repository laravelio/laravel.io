<nav class="{{ isset($hasShadow) ? 'mb-1 shadow' : '' }}">
    <div
        class="container mx-auto text-gray-800 lg:block lg:py-8"
        x-data="navConfig()"
        ...
        <div class="block bg-white 2xl:-mx-10">
            <div class="lg:flex lg:px-4">
                <div class="block lg:flex lg:shrink-0 lg:items-center">
                    ...
                    <div
                        class="mt-2 border-b lg:mt-0 lg:block lg:border-0"
                        x-cloak
                        :class="{ 'block': nav, 'hidden': !nav }"
                    >
                        <ul
                            class="mb-2 flex flex-col gap-y-2 px-4 lg:mb-0 lg:flex-row lg:gap-6"
                        >
                            <li
                            ...
                            <li class="rounded lg:mb-0 lg:hover:bg-gray-100">
                                <div
                                    @click.outside="chat = false"
                                    class="relative"
                                >
                                    <div>
                                        <button
                                            @click="chat = !chat"
                                            class="flex items-center px-2 py-1 lg:mb-0"
                                        >
                                            Chat
                                    ...
                                    <div x-show="chat" x-cloak>
                                        ...
                                        >
                                            <li
                                                class="my-4 lg:my-0 lg:hover:bg-gray-100"
                                            >
                                                <a
                                                    href="https://discord.gg/KxwQuKb"
                                                    class="inline-block w-full lg:px-4 lg:py-3"
                                                >
                                                    <x-si-discord
                                                        class="inline h-4 w-4 text-discord"
                                                    />
                                                    Discord
                                                </a>
                                            </li>
                                            ...
                                            <li
                                                class="mb-4 lg:mb-0 lg:hover:bg-gray-100"
                                            >
                                                <a
                                                ...
                                                >
                                                    <x-si-slack
                                                        class="inline h-4 w-4 text-red-400"
                                                    />
                                                    Larachat
                                                </a>
                                            </li>
                                ...
                                >
                                    ...
                                    <div x-show="community" x-cloak>
                                        ...
                                        >
                                            ...
                                            <li class="hover:bg-gray-100">
                                                <a
                                                    href="https://ecosystem.laravel.io"
                                                    class="inline-block w-full lg:px-4 lg:py-3"
                                                >
                                                    <img
                                                        loading="lazy"
                ...
                <div
                    class="block w-full gap-x-4 lg:flex lg:items-center lg:justify-end"
                >
                    ...
                    <ul
                        class="block gap-x-8 lg:flex lg:items-center"
                        x-cloak
                        :class="{ 'block': nav, 'hidden': !nav }"
                    >
                        @if (Auth::guest())
                            <li
                                class="w-full rounded text-center lg:hover:bg-gray-100"
                            >
                                <a
                                    href="{{ route('register') }}"
                                    class="inline-block w-full p-2.5"
                                >
                                    Register
                                </a>
                            </li>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        @can(App\Policies\UserPolicy::ADMIN, App\Models\User::class)
                                            <li
                                                class="mb-4 lg:mb-0 lg:border-b lg:border-t lg:hover:bg-gray-100"
                                            >
                                                <a
                                                    href="{{ route('admin') }}"
                                                    class="flex w-full items-center lg:px-3 lg:py-2"
                                        ...
                                        >
                                            <x-buk-logout
                                                class="flex w-full items-center text-left lg:px-3 lg:py-2"
                                            >
