            ...
            <div class="lg:flex lg:px-4">
                <div class="block lg:flex lg:shrink-0 lg:items-center">
                    <div class="flex items-center justify-between p-4 lg:p-0">
                        <a href="{{ route('home') }}" class="mr-4">
                            <img loading="lazy" class="h-6 w-auto lg:h-8" src="{{ asset('images/laravelio-logo.svg') }}"
                                width="330" height="78" alt="{{ config('app.name') }}" />
                        </a>
                    ...
                    <div class="mt-2 border-b lg:mt-0 lg:block lg:border-0" x-cloak
                            ...
                            <li class="rounded lg:mb-0 lg:hover:bg-gray-100">
                                <div @click.outside="chat = false" class="relative">
                                    ...
                                    <div x-show="chat" x-cloak>
                                        <ul
                                            class="ml-4 lg:absolute lg:z-50 lg:ml-0 lg:mt-2 lg:flex lg:w-36 lg:flex-col lg:rounded-md lg:bg-white lg:shadow-lg">
                                            <li class="my-4 lg:my-0 lg:hover:bg-gray-100">
                                                <a href="https://discord.gg/KxwQuKb"
                                            ...
                                            <li class="hover:bg-gray-100">
                                                <a href="https://web.libera.chat/?nick=laravelnewbie&channels=#laravel"
                                                    class="inline-block w-full lg:px-4 lg:py-3">
                                                    <x-heroicon-s-chat-bubble-oval-left-ellipsis
                                                        class="inline h-4 w-4 text-green-500" />
                                                    IRC
                                                </a>
                                            </li>
                                        </ul>
                            ...
                            <li class="rounded lg:mb-0 lg:hover:bg-gray-100">
                                <div @click.outside="community = false" class="relative">
                                    ...
                                    <div x-show="community" x-cloak>
                                        <ul
                                            class="ml-4 lg:absolute lg:z-50 lg:ml-0 lg:mt-2 lg:flex lg:w-48 lg:flex-col lg:rounded-md lg:bg-white lg:shadow-lg">
                                            <li class="mb-4 lg:mb-0 lg:hover:bg-gray-100">
                                                <a href="https://laravel.com"
                                                    class="inline-block w-full lg:px-4 lg:py-3">
                                                    <img loading="lazy" src="{{ asset('images/laravel.png') }}"
                                                        alt="Laravel" class="inline h-4 w-4" />
                                                    Laravel
                                                </a>
                                            </li>
                                            ...
                                            <li class="mb-4 lg:mb-0 lg:hover:bg-gray-100">
                                                <a href="https://laracasts.com"
                                                    class="inline-block w-full lg:px-4 lg:py-3">
                                                    <img loading="lazy" src="{{ asset('images/laracasts.png') }}"
                                                        alt="Laracasts" class="inline h-4 w-4" />
                                                    Laracasts
                                                </a>
                                            </li>
                                            ...
                                            <li class="mb-4 lg:mb-0 lg:hover:bg-gray-100">
                                                <a href="https://laravel-news.com"
                                                    class="inline-block w-full lg:px-4 lg:py-3">
                                                    <img loading="lazy" src="{{ asset('images/laravel-news.png') }}"
                                                        alt="Laravel News" class="inline h-4 w-4" />
                                                    Laravel News
                                                </a>
                                            </li>
                                            ...
                                            <li class="mb-4 lg:mb-0 lg:hover:bg-gray-100">
                                                <a href="https://www.laravelpodcast.com"
                                                    class="inline-block w-full lg:px-4 lg:py-3">
                                                    <img loading="lazy" src="{{ asset('images/podcast.png') }}"
                                                        alt="Laravel Podcast" class="inline h-4 w-4" />
                                                    Podcast
                                                </a>
                                            </li>

                                            <li class="hover:bg-gray-100">
                                                <a href="https://ecosystem.laravel.io"
                                                    class="inline-block w-full lg:px-4 lg:py-3">
                                                    <img loading="lazy"
                ...
                <div class="block w-full gap-x-4 lg:flex lg:items-center lg:justify-end">
                    <div class="flex items-center gap-x-4">
                        ...
                        <button @keydown.window.prevent.ctrl.k="showSearch($event)"
                            @keydown.window.prevent.cmd.k="showSearch($event)" @click="showSearch($event)"
                            @keyup.window.slash="showSearch($event)" class="hover:text-lio-500">
                    ...
                    <ul class="block gap-x-8 lg:flex lg:items-center" x-cloak
                        :class="{ 'block': nav, 'hidden': !nav }">
                        @if (Auth::guest())
                            ...
                            <li>
                                ...
                                <a href="{{ route('login') }}"
                                    class="block w-full bg-lio-500 p-2.5 text-center text-white lg:hidden">
                                    Login
                                </a>
                            </li>
                        @else
                            <li class="relative p-4 lg:p-0">
                                <div class="flex items-center justify-center">
                                    <a href="{{ route('notifications') }}"
                                        class="hidden shrink-0 rounded-full lg:block">
                                ...
                                <div x-show="settings" x-cloak class="mt-4 lg:mt-0">
                                    <ul
                                        class="flex flex-col items-center lg:absolute lg:z-50 lg:ml-0 lg:mt-2 lg:w-40 lg:items-stretch lg:rounded-md lg:bg-white lg:shadow-lg">
                                        <li class="mb-4 lg:mb-0 lg:hover:bg-gray-100">
                                            <a href="{{ route('profile') }}"
                                                class="flex w-full items-center lg:px-3 lg:py-2">
