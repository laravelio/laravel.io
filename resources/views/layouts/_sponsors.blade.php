<div class="container mx-auto mt-14 flex justify-center">
    <div class="mx-4 w-full text-center">
        <p class="mb-6 text-base md:mb-12 md:text-lg">
            ...
            <x-accent-text>amazing companies</x-accent-text>
            for supporting us
        </p>
        ...
        <div class="mt-8 flex justify-center">
            <div class="col-span-2 mr-10 flex justify-center lg:col-span-1">
                <x-sponsor-logo
                    ...
                    logo="{{ asset('images/sponsors/eventy.svg') }}"
                    company="Eventy"
                />
            </div>
        </div>
        ...
        <div class="mt-12 grid grid-cols-2 gap-y-8 lg:grid-cols-3">
            <div class="col-span-2 flex justify-center lg:col-span-1">
                <x-sponsor-logo
                    url="https://usefathom.com/ref/7A8QGC"
                    logo="{{ asset('images/sponsors/fathom.png') }}"
                    company="Fathom"
                />
            </div>
            ...
            <div class="col-span-2 flex justify-center lg:col-span-1">
                <x-sponsor-logo
                    ...
                    logo="{{ asset('images/sponsors/forge.png') }}"
                    company="Forge"
                />
            </div>
            ...
            <div class="col-span-2 flex justify-center lg:col-span-1">
                <x-sponsor-logo
                    ...
                    logo="{{ asset('images/sponsors/envoyer.png') }}"
                    company="Envoyer"
                />
            </div>
            ...
            <div class="col-span-2 flex justify-center lg:col-span-1">
                <x-sponsor-logo
                    ...
                    logo="{{ asset('images/sponsors/beyondcode.png') }}"
                    company="Beyond Code"
                />
            </div>
            ...
            <div class="col-span-2 flex justify-center lg:col-span-1">
                <x-sponsor-logo
                    url="https://www.skynettechnologies.com/hire-laravel-developer"
                    logo="{{ asset('images/sponsors/skynet-technologies.jpg') }}"
            ...
            <div class="col-span-2 flex justify-center lg:col-span-1">
                <x-sponsor-logo
                    url="https://steadfastcollective.com/uk-laravel-agency"
                    logo="{{ asset('images/sponsors/steadfast.svg') }}"
            ...
            <div class="col-span-2 flex justify-center lg:col-span-1">
                <x-sponsor-logo
                    ...
                    logo="{{ asset('images/sponsors/bairesdev.png') }}"
                    company="BairesDev"
                />
            </div>
            ...
            <div class="col-span-2 flex justify-center lg:col-span-1">
                <x-sponsor-logo
                    url="https://www.remotely.works/sponsoring-open-source-projects"
                    logo="{{ asset('images/sponsors/remotely.png') }}"
                    company="Remotely Works"
                />
            </div>
        </div>

        <x-ads.cta primary class="mt-8 md:mt-12">Your logo here?</x-ads.cta>
    </div>
</div>
