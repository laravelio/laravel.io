        ...
        <div class="sm:flex sm:justify-between sm:items-baseline">
            ...
            <div class="mt-4 sm:mt-0 sm:ml-10">
                <nav class="-mb-px flex space-x-8">
                    ...
                    <a href="{{ route('admin.posts') }}" class="{{ is_active('admin.posts') ? 'border-lio-500 text-lio-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }} whitespace-nowrap pb-4 px-1 border-b-2 font-medium text-sm" aria-current="page">
                        Posts
                    </a>
