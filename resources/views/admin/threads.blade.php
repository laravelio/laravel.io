...
@section('content')
    ...
    <main class="container mx-auto pb-10 lg:py-6 sm:px-4">
        <div class="flex flex-col">
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-gray-50">
                                    <tr>
                                        ...
                                        <x-tables.table-head>Subject</x-tables.table-head>
            ...
            @else
                <x-empty-state title="No threads have been posted yet" icon="heroicon-o-document-text" />
            @endif
        </div>
