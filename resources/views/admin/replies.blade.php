...
@section('content')
    ...
    <main class="container mx-auto pb-10 sm:px-4 lg:py-6">
        <div class="flex flex-col">
                                    ...
                                    @foreach ($replies as $reply)
                                        <tr>
                                            <x-tables.table-data>
                                                <div class="flex items-center">
                                                    ...
                                                    <div class="ml-4">
                                                        ...
                                                        >
                                                            <a
                                                                href="{{ route('profile', $reply->author()->username()) }}"
                                                            >
                                                                {{ $reply->author()->name() }}
                                                            </a>
                                                        </div>
                                            ...
                                            <x-tables.table-data>
                                                @if ($reply->updatedBy())
                                                    <span
                                                        class="inline-flex items-center rounded-full bg-lio-100 px-2.5 py-0.5 text-xs font-medium text-gray-800"
                                                    >
                                                        YES
                                                    </span>
                                                @else
            ...
            @else
                <x-empty-state
                    title="No replies have been posted yet"
