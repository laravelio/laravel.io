                                    ...
                                    @foreach ($replies as $reply)
                                        <tr>
                                            ...
                                            <x-tables.table-data>
                                                @if ($reply->updatedBy())
                                                    <span
                                                        class="inline-flex items-center rounded-full bg-lio-100 px-2.5 py-0.5 text-xs font-medium text-gray-800">YES</span>
                                                @else
                                                    <span
                                                        class="inline-flex items-center rounded-full bg-gray-100 px-2.5 py-0.5 text-xs font-medium text-gray-800">NO</span>
                                                @endif
                                            </x-tables.table-data>

                                            <x-tables.table-data class="w-10 text-center">
                                                <a href="{{ route('thread', $reply->replyAble()->slug()) }}#{{ $reply->id() }}"
