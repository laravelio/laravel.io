    ...
    */
    'ignore_errors' => [
        Enlightn\Enlightn\Analyzers\Reliability\InvalidReturnTypeAnalyzer::class => [
            ...
            ['path' => 'app/Http/Requests/ArticleRequest.php', 'details' => '*'],
            ['path' => 'app/Http/Requests/CreateReplyRequest.php', 'details' => '*'],
            ['path' => 'app/Http/Requests/RegisterRequest.php', 'details' => '*'],
            ['path' => 'app/Http/Requests/SeriesRequest.php', 'details' => '*'],
            ['path' => 'app/Http/Requests/ThreadRequest.php', 'details' => '*'],
            ['path' => 'app/Http/Requests/UpdatePasswordRequest.php', 'details' => '*'],
