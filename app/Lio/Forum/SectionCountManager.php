...
class SectionCountManager
{
    protected $fetcher;

    public function __construct(SectionTimestampFetcher $fetcher, $sections)
    {
    ...
    public function getCounts($lastVisited)
    {
        ...
        $calculator = new SectionUpdateCountCalculator($this->sections, $lastVisited, $timestamps);
